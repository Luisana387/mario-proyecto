...
let puntaje= document.querySelector(".puntaje"); // Variable para llevar la puntuación del jugador
...
const SonidoVictoria = new Audio ("/sonido/Level_Clear.wav");
const SonidoMuerto = new Audio ("./sonido/Die.wav");
const SonidoPausa = new Audio ("/sonido/Pause.wav");
